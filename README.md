...
El repositorio incluye un `Dockerfile` y un archivo `docker-compose.yml` listos para orquestar la aplicación (Django + Nginx).
...
2. Clonar el repositorio y acceder a la raíz del proyecto.
...
4. Instalar todas las dependencias:
   ...
   ```
5. Aplicar migraciones base y recolectar estáticos:
   ```bash
